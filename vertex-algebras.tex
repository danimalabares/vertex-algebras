...
for all $a \in V$, a quantu field $Y^M(a,z)$ on $M$
...
\begin{align*}
L_{-1}|\mu\rangle&=\frac{1}{2}\sum_i \left(
\sum_{k \in \mathbb{Z}}\,:\!a^i_{-1-k}b^i_k\!:\,\right)\\
\sum_{k \in \mathbb{Z}}a^i_{-1-k}b^i_k\right),\qquad \text{since they commute}\\
...
$$
\partial_z\Gamma^\mu(z)\underbrace{=}_{\substack{\text{for} \\\text{vertex
