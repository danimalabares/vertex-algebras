...
and
$$
\varphi^*(w)=\sum_{ n \in \mathbb{Z}}\varphi_{(n)^*}w^{n}
$$
...
$$
2\quad 1 \quad  1\quad 1 \quad 3 \quad 3 \quad  1 \quad 2 \quad 1
\quad  1 \quad  \ldots
$$
...
We would like to 
(define an endomorphism of the wedge)
