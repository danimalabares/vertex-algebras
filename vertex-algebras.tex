...
\bigoplus_{n \in \mathbb{Z}}\mathbb{C}h_n$ the Heisenberg Lie algebra,
...
So $(\sum h_{m-k}h)k)p(\underline{x})$ is a \underline{finite} sum.
...
|[T,a(Z)]&=\partial_za(z)\}\\
\overline{\mathcal{F}}&=\bigcup_{k\geq 0}\mathcal{F}_k,\qquad 
\mathcal{F}_0=\{I_V\},\qquad 
...
To be sure, we should chec $\overline{\mathcal{F}}\subset \tilde{\mathcal{F}}$.
\end{remark}
