...
We consider wights $\Lambda=k\Lambda_0+\lambda$, $\lambda \in \mathfrak{h}^*$,
...
n \frac{\partial }{\partial x_n}\qquad &\text{if }n>0, \substack{
h_0\mapsto 0 \\
k \mapsto \text{Id} } \\
...
\qquad H_n=\text{span}\{x_{n_1},\ldots,x_{m_s}|
\sum m_s=n\}.
$$
